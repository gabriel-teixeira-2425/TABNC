 ...
 * Uso: Icons.get('name', size?, extraClass?)
 */
const Icons = {
  _svg: (path, vb = '0 0 24 24') =>
    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="${vb}" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">`,

  map: {
    dashboard:    `<polyline points="3 9 12 2 21 9"/><path d="M9 22V12h6v10"/><path d="M3 9v13h18V9"/>`,
    ticket:       `<rect x="2" y="5" width="20" height="14" rx="2"/><path d="M16 5v14M8 5v14M2 12h4m12 0h4"/>`,
    ...
    bellActive:   `<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/><circle cx="18" cy="4" r="3" fill="var(--red)" stroke="none"/>`,
    ...
    sortAsc:      `<polyline points="18 15 12 9 6 15"/>`,
  ...
  get(name, size = 16, cls = '') {
    const d = this.map[name] || this.map['info'];
    return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" width="${size}" height="${size}" class="icon-svg ${cls}">${d}</svg>`;
  }
};
